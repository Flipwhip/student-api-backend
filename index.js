...
const demoStudents = [
  {
    ...
    surname: "Петров",
    lastname: "Сергеевич",
    birthday: "1998-05-12T10:00:00.000Z",
    studyStart: "2016",
    faculty: "Информатика и вычислительная техника",
    createdAt: "2025-05-06T16:16:23.557Z",
    updatedAt: "2025-05-06T16:16:23.557Z",
  },
  {
    id: "1746548183637",
    name: "Алексей",
    surname: "Смирнов",
    lastname: "Дмитриевич",
    birthday: "1999-11-05T09:30:00.000Z",
    studyStart: "2017",
    faculty: "Юридический",
    createdAt: "2025-05-06T16:16:23.637Z",
    updatedAt: "2025-05-06T16:16:23.637Z",
  },
  {
    id: "1746548183659",
    name: "Елена",
    surname: "Кузнецова",
    lastname: "Игоревна",
    birthday: "2001-08-15T14:45:00.000Z",
    studyStart: "2019",
    faculty: "Филологический",
    createdAt: "2025-05-06T16:16:23.659Z",
    updatedAt: "2025-05-06T16:16:23.659Z",
  },
  {
    id: "1746548183663",
    name: "Дмитрий",
    surname: "Соколов",
    lastname: "Андреевич",
    birthday: "1997-02-20T08:20:00.000Z",
    studyStart: "2015",
    faculty: "Физический",
    createdAt: "2025-05-06T16:16:23.663Z",
    updatedAt: "2025-05-06T16:16:23.663Z",
  },
];
 ...
 * @param {boolean} [checkForDemo=false] - Проверять ли необходимость добавления демо-студентов
...
function getStudentList(params = {}, checkForDemo = false) {
  let students = JSON.parse(readFileSync(DB_FILE, "utf8"));

  // Добавляем демо-студентов ТОЛЬКО если это GET-запрос и база пуста
  if (checkForDemo && students.length === 0) {
    students = demoStudents;
    writeFileSync(DB_FILE, JSON.stringify(students), { encoding: "utf8" });
    console.log("База была пуста, добавлены демо-студенты");
  }
...
function createStudent(data) {
  ...
  // Проверяем лимит (не более 5 студентов)
  if (students.length >= 5) {
    throw new ApiError(400, {
      message: "Достигнут лимит студентов (максимум 5)",
    });
  }
  ...
  writeFileSync(DB_FILE, JSON.stringify([...students, newItem]), {
    encoding: "utf8",
  });
  return newItem;
}
...
module.exports = createServer(async (req, res) => {
  ...
  try {
    ...
    const body = await (async () => {
      if (uri === "" || uri === "/") {
        // /api/students
        if (req.method === "GET") return getStudentList(queryParams, true);
        if (req.method === "POST") {
